...
bool overlord100_msgs__msg__wheels_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("overlord100_msgs.msg._wheels_data.WheelsData", full_classname_dest, 44) == 0);
  }
  overlord100_msgs__msg__WheelsData * ros_message = _ros_message;
  {  // left
...
{
  /* NOTE(esteve): Call constructor of WheelsData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("overlord100_msgs.msg._wheels_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WheelsData");
